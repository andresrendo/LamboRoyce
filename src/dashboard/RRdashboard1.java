 ...
 * @author Juan
 */
public class RRdashboard1 extends javax.swing.JPanel {
    VehiclePlant RoycePlant;
...
//    VehiclePlant LamboPlant = new VehiclePlant("Lamborghini", 11, valoresIniciales[0], valoresIniciales[1], true);
    ...
    public void setRoycePlant(VehiclePlant RoycePlant){
        this.RoycePlant = RoycePlant;
        setWorkersSpinners();
        setWorkersLeft();
    ...
    public void setWorkersLeft(){
        int cantidadActual = Functions.calcWorkersQty(RoycePlant.emplPorDepto);
        int restan = RoycePlant.maxWorkerQty - cantidadActual;
        this.empleadosDispo.setText(Integer.toString(restan));
    }
    
    public void setWorkersSpinners(){
        this.qtyWChasis.setValue(RoycePlant.emplPorDepto[0]);
        this.qtyWCarroceria.setValue(RoycePlant.emplPorDepto[1]);
        this.qtyWMotor.setValue(RoycePlant.emplPorDepto[2]);
        this.qtyWAcc.setValue(RoycePlant.emplPorDepto[3]);
        this.qtyWRuedas.setValue(RoycePlant.emplPorDepto[4]);
        this.qtyWEnsamblador.setValue(RoycePlant.emplPorDepto[5]);
    }
...
//    }
    ...
    private void qtyWChasisStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_qtyWChasisStateChanged
        ...
        valor = Functions.validarCantEmpl(RoycePlant, TipoWorker.chasis, valor);
    ...
    private void qtyWMotorStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_qtyWMotorStateChanged
        ...
        // validar valor para ver si no excede limite de workers
        valor = Functions.validarCantEmpl(RoycePlant, TipoWorker.motor, valor);
    ...
    private void qtyWCarroceriaStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_qtyWCarroceriaStateChanged
        ...
        // validar valor para ver si no excede limite de workers
        valor = Functions.validarCantEmpl(RoycePlant, TipoWorker.carroceria, valor);
    ...
    private void qtyWRuedasStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_qtyWRuedasStateChanged
        ...
        // validar valor para ver si no excede limite de workers
        valor = Functions.validarCantEmpl(RoycePlant, TipoWorker.ruedas, valor);
    ...
    private void qtyWAccStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_qtyWAccStateChanged
        ...
        // validar valor para ver si no excede limite de workers
        valor = Functions.validarCantEmpl(RoycePlant, TipoWorker.accesorios, valor);
    ...
    private void qtyWEnsambladorStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_qtyWEnsambladorStateChanged
        ...
        // validar valor para ver si no excede limite de workers
        valor = Functions.validarCantEmpl(RoycePlant, TipoWorker.ensamblador, valor);
